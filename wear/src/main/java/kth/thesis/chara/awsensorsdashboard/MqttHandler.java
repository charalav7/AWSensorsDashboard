...
public class MqttHandler implements MqttCallback {
    ...
    private static String ORG = "quickstart"; //to be changed
    private static String DEVICE_TYPE = "<give type>"; //to be changed
    private static String DEVICE_ID = "<give id>"; //to be changed
